...
<html>
	...
	<body>
		...
		<div id="content">
			<a href=".." class="goback">Back to Course project</a>
			<h2>Student Info</h2>
				...
				<form action="" method="post" name="frmaddstud" id="frmaddstud">
					<table>
						<tbody>
							...
							<tr>
								<td class="lbl"><label for="txtaddinvst">Investigator : </label></td>
								<td class="inp"><input type="text" name="txtaddinvst" id="txtaddinvst" /></td>
								<td class="err"></td>
							</tr>
						</tbody>
					</table>
				...
				<form action="" method="post" name="frmupdstud" id="frmupdstud">
					<table>
						<tbody>
							...
							<tr>
								<td class="lbl"><label for="txtupdinvst">Investigator : </label></td>
								<td class="inp"><input type="text" name="txtupdinvst" id="txtupdinvst" /></td>
								<td class="err"></td>
							</tr>
						</tbody>
					</table>
				...
				<form action="" method="post" name="frmdelstud" id="frmdelstud">
					<table>
						<tbody>
							...
							<tr>
								<td class="lbl"><label for="txtdelinvst">Investigator : </label></td>
								<td class="inp"><input type="text" name="txtdelinvst" id="txtdelinvst" /></td>
								<td class="err"></td>
							</tr>
						</tbody>
					</table>
